...
<?php slot('title', __('Habitaciones - Hotel Boutique Sutherland House Valparaíso, Chile'))?>
...
<div id="menusecundario" class="habitaciones"><ul>
<li><a href="#Habitacion101" onclick="_gaq.push(['_trackEvent', 'Habitacion', 'IrA', '101']);">101</a></li>
<li><a href="#Habitacion201" onclick="_gaq.push(['_trackEvent', 'Habitacion', 'IrA', '201']);">201</a></li>
<li><a href="#Habitacion202" onclick="_gaq.push(['_trackEvent', 'Habitacion', 'IrA', '202']);">202</a></li>
<li><a href="#Habitacion203" onclick="_gaq.push(['_trackEvent', 'Habitacion', 'IrA', '203']);">203</a></li>
<li><a href="#Habitacion204" onclick="_gaq.push(['_trackEvent', 'Habitacion', 'IrA', '204']);">204</a></li>
<li><a href="#Habitacion301" onclick="_gaq.push(['_trackEvent', 'Habitacion', 'IrA', '301']);">301</a></li>
<li><a href="#Habitacion302" onclick="_gaq.push(['_trackEvent', 'Habitacion', 'IrA', '302']);">302</a></li>
<li><a href="#Habitacion303" onclick="_gaq.push(['_trackEvent', 'Habitacion', 'IrA', '303']);">303</a></li>
<li><a href="#Habitacion304" onclick="_gaq.push(['_trackEvent', 'Habitacion', 'IrA', '304']);">304</a></li>
<!--<li><a href="#tarifa1" onclick="_gaq.push(['_trackEvent', 'Habitacion', 'Tarifas', '']);">Tarifas</a></li>-->
</ul></div>
<p>&nbsp;</p>
<h2><?php echo __('Habitaciones') ?></h2>
<p><?php echo __('Nuestro hotel cuenta con 9 habitaciones: todas cómodas y luminosas, con vista a la bahía y cerros de Valparaíso') ?>
...
<p><?php echo __('Los baños de nuestras habitaciones tienen un diseño con reminiscencias de los antiguos baños, constan de un mueble en pino Oregón, un vanitorio y una grifería que representan al lavatorio y la jarra que usaba antiguamente.')?></p>
<table id="habitacion">
<tbody>
<tr>
