...
<h2><?php echo __('Año Nuevo %year% en Hotel Boutique Sutherland House<br/>', array('%year%' => date('Y')+1))?></h2>
...
<p><?php echo __('Programa dos incluye 1 noches y 2 días de alojamiento desde el 31 de Diciembre %year_old% hasta el 01 de Enero de %year_new% para 2 personas.', array('%year_old%' => date('Y'), '%year_new%' => date('Y')+1))?></p> - Desde $480.000 CLP
...
<b>21.15 <?php echo __('horas')?>:</b> Coctel de bienvenida<br/>
...
<h3>31 <?php echo __('de diciembre')?>:</h3> Programa (2) incluye Check in desde las 09.00 con desayuno incluido
...
- <?php echo __('Tres Ceviches')?><br/>
- <?php echo __('Ensaladas')?><br/>
- <?php echo __('Quesos y Jamones')?><br/>
<h4><?php echo __('PLATOS PRINCIPALES')?></h4>
- <?php echo __('Carne en salsa de setas')?><br/>
- <?php echo __('Pescados en salsa de mariscos')?><br/>
...
<p><b>"<?php echo __('Sorteo de una noche de alojamiento para un fin de semana en habitación con terraza entre quienes se hospeden en el hotel')?>."</p>
<p><b>09 a 13 <?php echo __('horas')?>:</b><?php echo __('Brunch (desayuno/almuerzo).')?><br/>
...
<td><?php echo upload_tag('habitacion/habitacion 204 Hotel Sutherland House Noche.JPG', array('size' => '300x201', 'alt' => __('Habitación 204 - Doble')))?><br/><b><?php echo __('Habitación 204 - Doble')?></b><br/><?php if($tarifas):?><?php if(true):?><strong style="color: red;"><?php echo __('RESERVADA')?></strong><?php else:?><?php echo __('Valor Promoción')?>: $ 850.000 <b>*</b><?php endif?><?php endif?></td>
...
<p><b>*</b>: Valor programa con cama adicional sólo habitación 202 $ 450.000 más</p>
