...
<b>16.30 <?php echo __('horas')?>:</b>  <?php echo __('Check out.')?></p>
    ...
    <table>
        ...
        <tbody>
        <tr><td>101</td><td>Suite</td><?php if(true):?><td colspan="3">Reservada</td><?php else: ?><td>1.700</td><td>900.000</td><td>630.000</td><?php endif?></tr>
        ...
        <tr><td>203</td><td>Suite (Con opción a doble)</td><?php if(true):?><td colspan="3">Reservada</td><?php else: ?><td>1.700</td><td>850.000</td><td>580.000</td><?php endif?></tr>
        ...
        <tr><td>303</td><td>Suite King corner</td><?php if(true):?><td colspan="3">Reservada</td><?php else: ?><td>1.830</td><td>980.000</td><td>680.000</td><?php endif?></tr>
